...
namespace DiarioProducao.Classes.ProducaoItemInicio
{
  public class Classe
  {
    ...
    public Int64 NumSerieLmpiini
    {
      get
      {
        return GetColumnValueInt64 ( "serie_producao_item_inicio" );
      }
      set
      {
        SetColumnValue ( "serie_producao_item_inicio", value );
      }
    }
    ...
    /// <summary>
    /// Cria uma instância vazia do objeto lor_man_producao_item_inicio
    /// </summary>
    /// <returns>
    /// </returns>
    public Classe ( )
    ...
    /// <summary>
    /// Cria uma instância do objeto lor_man_producao_item_inicio a partir dos campos de sua chave primária
    /// </summary>
    /// <param name="bcoSql">
    /// Configuração do banco de dados alvo
    /// </param>
    ...
    /// Configuração de tipo de acesso ao banco
    /// </param>
    /// <param name="numSerieLmpiini">
    /// Número de série do registro
    /// </param>
    /// <returns>
    /// </returns>
    public Classe ( Config bcoSql, String openQuery, Int64 numSerieLmpiini )
    {
      _bcoSql = bcoSql;
      _openQuery = openQuery;
      CriaColunas ( );
    ...
    /// <summary>
    /// Cria uma instância do objeto lor_man_producao_item_inicio a partir de sua chave primária
    /// </summary>
    /// <param name="bcoSql">
    /// Configuração do banco de dados alvo
    /// </param>
    ...
    /// <summary>
    /// Cria uma instância do objeto lor_man_producao_item_inicio a partir de sua chave alternativa
    /// </summary>
    /// <param name="bcoSql">
    /// Configuração do banco de dados alvo
    /// </param>
    ...
    private void PopulaRecord ( SqlDataReader dataReader = null )
    {
      if ( dataReader != null )
      {
        SetColumnValue ( "serie_producao_item_inicio", Convert.ToInt64 ( dataReader [ "serie_producao_item_inicio" ] ) );
      ...
      {
        SetColumnValue ( "serie_producao_item_inicio", 0L );
    ...
    /// <summary>
    /// Faz a leitura no banco de dados de um registro da tabela lor_man_producao_item_inicio através de sua chave primária
    /// </summary>
    /// <param name="chavePrimaria">
    ...
    private void Select ( Pk chavePrimaria )
    {
      if ( chavePrimaria.Ok )
      {
        ...
        sql.AppendFormat ( Sql.QueryRecordPk, _openQuery, chavePrimaria.NumSerieLmpiini );
    ...
    /// <summary>
    /// Faz a leitura no banco de dados de um registro da tabela lor_man_producao_item_inicio através de sua chave Alternativa
    /// </summary>
    /// <param name="chaveAlternativa">
    /// Chave alternativa da tabela
    /// </param>
    ...
    private Boolean ValidaHoraInicio ( )
    {
      return !String.IsNullOrEmpty ( HoraInicio ) && !String.IsNullOrWhiteSpace ( HoraInicio );
    }
    ...
    private Boolean Valida ( )
    {
      ...
      retorno = retorno & ValidaHoraInicio ( );
    ...
    public void Delete ( )
    {
      ...
      if ( NumSerieLmpiini != 0L )
      {
        ...
        sqlDependencia.AppendFormat ( Sql.ExisteDependencias, _openQuery, NumSerieLmpiini );
    ...
    /// false - Não existe registro
    /// </returns>
    public Boolean ExistePk ( Int64 numSerieLmpiini )
    {
      var sql = new StringBuilder ( );
      sql.Clear ( );
      sql.AppendFormat ( Sql.ExistePk, _openQuery, numSerieLmpiini );
      return ExisteComum ( sql.ToString ( ) );
    }
    ...
    public Boolean ExistePk ( Pk chavePrimaria )
    {
      var sql = new StringBuilder ( );
      sql.Clear ( );
      sql.AppendFormat ( Sql.ExistePk, _openQuery, chavePrimaria.NumSerieLmpiini );
      return ExisteComum ( sql.ToString ( ) );
    }
