...
namespace DiarioProducao.Classes.ProducaoItemOcorrencia
{
  public class Classe
  {
    ...
    private void CriaColunas ( )
    {
      ...
      {
        new Coluna( 0, "serie_producao_item_ocorrencia", "Série", typeof( Int64 ), true, false, false ),
        new Coluna( 1, "serie_producao_item", "Série Produção", typeof( Int64 ), false, true, false ),
        new Coluna( 2, "serie_ocorrencia", "Série Ocorrência", typeof( Int64 ), false, true, false ),
